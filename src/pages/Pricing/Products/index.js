    ...
    constructor(props) {
        ...
        this.state = {
            products: [
                ...
                { name: "Olive Shower Gel", price: "P 1,095/750ml", image: product2, link: "olive-shower-gel", desc: "The Olive Shower Gel is a soap-free, lather-rich shower gel that contains organic, cold-pressed olive oil. The shower staple has a fresh, delicate scent that leaves skin smelling great and feeling rejuvenated." },
